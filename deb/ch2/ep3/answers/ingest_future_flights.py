    ...
    def process(self, element, airports, *args, **kwargs):
        ...
        try:
            ...
            if element['src'] in airports:
                ...
                reject = True
                yield beam.pvalue.TaggedOutput('missing_airport', (element['src'], 1))
            ...
            if element['dest'] in airports:
                ...
                yield beam.pvalue.TaggedOutput('missing_airport', (element['dest'], 1))
    ...
    def process(self, element, routes, *args, **kwargs):
        ...
        try:
            ...
            if route in routes:
                ...
                yield beam.pvalue.TaggedOutput('missing_route', (route, 1))  # also send the route as missing
        except (KeyError, ValueError, TypeError) as err:
            logger.debug(f"input flight record is missing critical fields or of invalid type.")
            logger.debug(str(err))
